    ...
    def accumulate_gradients(self, phase, real_img, real_c, gen_z, gen_c, sync, gain):
        ...
        if do_Dmain:
            ...
            with torch.autograd.profiler.record_function('Dgen_backward'):
                ...
                pass #TODO: loss_Dgen is used in KD loss refactor
        ...
        if do_Dmain or do_Dr1:
            ...
            with torch.autograd.profiler.record_function(name + '_forward'):
                ...
                if do_Dmain:
                    ...
                    with torch.autograd.profiler.record_function('KD_Discriminator_backward'):
                        """
                        KD LOSS: torch.Size([8, 1])
                        loss_Dgen: torch.Size([8, 1])
                        """
                        (loss_kd + loss_Dgen).mean().mul(gain).backward()
...
class KDDiscriminatorLoss(nn.Module):
    ...
    def __init__(self,
        ...
        self.text_labels = self.batch_size * ['a photo of obama']
        self.K = len(self.text_labels)
    ...
    def correlatedDistillation(self, fake_data, fake_embeddings):
        ...
        text_features = self.clip.text_features(self.text_labels)
        ...
        # return torch.mean(L_CGKD)
        # return L_CGKD.to(self.device)