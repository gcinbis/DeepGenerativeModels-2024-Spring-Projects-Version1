...
dataset_module = dict(
    ...
    train_dataset_config=dict(image_size=256, image_dir_hr="data2/dataset_cropped/hr", image_dir_lr="data2/dataset_cropped/lr", downsample_factor=4,mirror_augment_prob=0.5),
...
synthesize_callback_test = dict(num_samples=6, eval_every=200)
fid_callback = dict(eval_every=100)
